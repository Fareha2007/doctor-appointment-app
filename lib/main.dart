...
//       // Sets the starting point of the app to your AuthGate.
//       home: const AuthGate(),
//       // Defines all the named routes for your app.
//       getPages: [
//         GetPage(name: '/', page: () => const AuthGate()),
//         GetPage(name: '/login', page: () => LoginScreen()),
//         GetPage(name: '/signup', page: () => SignupScreen()),
        
//         // 3. FIXED: '/home' now correctly points to the patient's HomeScreen.
