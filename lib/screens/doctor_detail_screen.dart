...
class DoctorDetailsScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    const String doctorId = '0XLc13fcFiVsj1d6LI6crvXNVN23';
    const String doctorName = 'Dr. Samina Zaki';
    const String imagePath = 'assets/images/doctor.png';
    const String specialty = 'Homeopath';
    const String qualifications =
        'B.H.M.S., Advanced Training in Homeopathy, Certificate course in Personal Counseling, Certificate course in NLP';
    const String aboutMe =
        'Dr. Samina Zaki specializes in holistic homeopathy treatments with a focus on personalized care and natural healing.';
    const String workingTime = 'Mon–Sat, 10:00 AM–1:00 PM & 6 PM - 9 PM';

    final Map<String, dynamic> review = {
      'reviewerName': 'Huma Khan',
      'reviewerImage': 'assets/images/reviewer.jpeg',
      'comment':
          'Dr. Samina is very caring and her treatments are highly effective. I felt much better within weeks!',
    };
          ...
          child: Column(
            ...
            children: [
              ...
              Row(
                ...
                children: [
                  _buildStat(Icons.group, '18,000+', 'patients'),
                  _buildStat(Icons.medical_services, '15+', 'experience'),
                  _buildStat(Icons.star, '10.0', 'rating'),
                  _buildStat(Icons.chat_bubble, '950', 'reviews'),
                ],
              ),
              const SizedBox(height: 20),
