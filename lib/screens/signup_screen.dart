...
//                 _buildTextField(controller.birthDateController, "Birth date"),
...
//   ///  method to create consistent text fields
...
//         decoration: _inputDecoration(label, obscure: isPassword),
//       ),
//     );
//   }

//   InputDecoration _inputDecoration(String label, {bool obscure = false}) {
...
//   // 2. Update _inputDecoration to use the suffixIcon
//   InputDecoration _inputDecoration(String label, {Widget? suffixIcon}) {
//     return InputDecoration(
//       labelText: label,
//       suffixIcon: suffixIcon, // Use the parameter here
//       border: OutlineInputBorder(
//         borderRadius: BorderRadius.circular(12),
...
//   // It's better to put the controller once, not inside the build method.
//   final SignupController controller = Get.put(SignupController());
...
//           ),
//           child: Form( // 1. Form widget added for validation
//             key: _formKey,
//             child: Column(
//               crossAxisAlignment: CrossAxisAlignment.center,
//               children: [
...
//                   validator: (value) => value!.isEmpty || !value.isEmail ? "Please enter a valid email" : null,
//                 ),
//                 _buildTextField(
...
//         decoration: _inputDecoration("Birth date", suffixIcon: const Icon(Icons.calendar_today)),
//         onTap: () async {
//           // Hide keyboard
